...
const ConsultingSection = () => {
  ...
  return (
    <section id="consulting" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div>
            ...
            <a
              href="#reservation"
              className="inline-flex items-center gap-2 rounded-full bg-accent px-8 py-4 font-body font-semibold text-accent-foreground transition-all hover:shadow-glow hover:scale-[1.02]"
            >
           ...
           <div className="relative hidden lg:block min-h-[500px]">
             ...
             <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-2xl transition-transform duration-700 hover:rotate-1">
               <img 
                 src={gallerySouk} 
             ...
             {/* Floating Glass Card */}
             <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 shadow-xl text-white">
                <h3 className="font-heading text-2xl font-bold mb-3 text-white">A Refined Approach</h3>
                <p className="font-body text-white/90 mb-3 text-sm leading-relaxed">
